...
\fig[scale=0.3]{src/img/cnc.png}{img:cnc}{A deforming triangle in time interval [0, 1] (left). The continuous normal cone for the triangle (right). Source: \citep{tang08}}
